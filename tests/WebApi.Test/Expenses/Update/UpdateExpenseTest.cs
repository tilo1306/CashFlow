...
public class UpdateExpenseTest : CashFlowClassFixture
{
  ...
  public async Task Success()
  {
    ...
    var result = await DoPut(requestUrl: $"{METHOD}/{_expenseId}", requestBody: request, token: _token);
  ...
  public async Task Error_Title_Empty(string culture)
  {
    ...
    var result = await DoPut(requestUrl: $"{METHOD}/{_expenseId}", requestBody: request, token: _token, culture: culture);
  ...
  public async Task Error_Expense_Not_Found(string culture)
  {
    ...
    var result = await DoPut(requestUrl: $"{METHOD}/1000", requestBody: request, token: _token, culture: culture);
